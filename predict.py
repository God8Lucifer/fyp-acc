...
pipeline = RelationshipPipeline(
    model_path="outputs/RGCN_model.pth",
    features_path="outputs/x_features.pt",         
    edge_index_path="outputs/edge_index.pt",
    edge_type_path="outputs/edge_type.pt",
    cid_map_path="outputs/cid_to_idx.pkl",
    df_path="outputs/df.csv"
)
